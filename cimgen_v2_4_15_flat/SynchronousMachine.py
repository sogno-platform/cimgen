from cimpy.cimgen_v2_4_15_flat_9.RotatingMachine import RotatingMachine
...
class SynchronousMachine(RotatingMachine):
	...
	possibleProfileList = {'class': ['DY', 'EQ', 'SSH', ],
						...
						'InitialReactiveCapabilityCurve': ['EQ', ],
						'maxQ': ['EQ', ],
						'minQ': ['EQ', ],
						'qPercent': ['EQ', ],
						'type': ['EQ', ],
						'earthing': ['EQ', ],
						'earthingStarPointR': ['EQ', ],
						'earthingStarPointX': ['EQ', ],
						'ikk': ['EQ', ],
						'mu': ['EQ', ],
						'r0': ['EQ', ],
						'r2': ['EQ', ],
						'satDirectSubtransX': ['EQ', ],
						'satDirectSyncX': ['EQ', ],
						'satDirectTransX': ['EQ', ],
						'shortCircuitRotorType': ['EQ', ],
						'voltageRegulationRange': ['EQ', ],
						'r': ['EQ', ],
						'x0': ['EQ', ],
						'x2': ['EQ', ],
						'operatingMode': ['SSH', ],
						'referencePriority': ['SSH', ],
												}
