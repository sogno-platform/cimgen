from cimpy.cimgen_v2_4_15_flat_9.ConductingEquipment import ConductingEquipment
...
class PowerTransformer(ConductingEquipment):
	...
	possibleProfileList = {'class': ['EQ', ],
						'PowerTransformerEnd': ['EQ', ],
						'beforeShCircuitHighestOperatingCurrent': ['EQ', ],
						'beforeShCircuitHighestOperatingVoltage': ['EQ', ],
						'beforeShortCircuitAnglePf': ['EQ', ],
						'highSideMinOperatingU': ['EQ', ],
						'isPartOfGeneratorUnit': ['EQ', ],
						'operationalValuesConsidered': ['EQ', ],
												}
