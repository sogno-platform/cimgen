from cimpy.cimgen_v2_4_15_flat_9.ACDCTerminal import ACDCTerminal
...
class Terminal(ACDCTerminal):
	...
	possibleProfileList = {'class': ['DY', 'EQ', 'SV', 'SSH', 'TP', ],
						'ConductingEquipment': ['DY', 'EQ', ],
						'RemoteInputSignal': ['DY', ],
						'ConverterDCSides': ['EQ', ],
						'phases': ['EQ', ],
						'RegulatingControl': ['EQ', ],
						'TieFlow': ['EQ', ],
						'TransformerEnd': ['EQ', ],
						'HasFirstMutualCoupling': ['EQ', ],
						'HasSecondMutualCoupling': ['EQ', ],
						'SvPowerFlow': ['SV', ],
						'TopologicalNode': ['TP', ],
												}
